...
_.extend(Piwik.prototype, {
    _invoke: function (methodName, args) {
        if (this.debug) {
            console.log(
                "Piwik: About to invoke " + methodName + " with args:",
                args
            );
        }
    ...
    setCustomVariable: function (variableDefinition, value) {
        this._invoke("setCustomVariable", [
    ...
    trackImpression: function (contentName, contentPiece, contentTarget) {
        this._invoke("trackContentImpression", [
            contentName,
            contentPiece,
            contentTarget,
        ]);
    ...
    trackVisibleImpression: function (checkOnScroll, timeInterval) {
        this._invoke("trackVisibleContentImpressions", [
            checkOnScroll,
            timeInterval,
        ]);
    },
    ...
    trackContentInteraction: function (
        ...
        this._invoke("trackContentInteraction", [
            interaction,
            contentName,
            contentPiece,
            contentTarget,
    ...
    trackDomNodeInteraction: function (domNode, contentInteraction) {
        this._invoke("trackContentInteractionNode", [
            domNode,
            contentInteraction,
        ]);
    },
