...
class ModalGroupView extends Backbone.Modal.extend({
     ...
     */
    initialize(options) {
        if (options && "title" in options) this.title = options.title;
    ...
    getGroupContentView() {
        console.log(
            ...
            this.model,
            "in:",
            _.clone(this.groupsView.children.indexByModel)
        );
        console.log(
            "Result: ",
            this.groupsView.children.findByModel(this.groupSpecModel)
        );
