...
class IdeaFamilyView extends Backbone.View.extend({
    ...
    initialize(obj) {
        ...
        this.innerViewClassInitializeParams =
            obj.innerViewClassInitializeParams;
    }
    ...
    render() {
        ...
        var ideaView = new this.innerViewClass(
            _.extend({ model: this.model }, this.innerViewClassInitializeParams)
        );
        ...
        this.$el
            .find(">.ideafamily-body>.ideafamily-idea")
            .append(ideaView.render().el);
        ...
        _.each(render_data["children"], function (idea) {
            var ideaFamilyView = new IdeaFamilyView({
                ...
                innerViewClassInitializeParams:
                    that.innerViewClassInitializeParams,
            });
            rendered_children.push(ideaFamilyView.render().el);
        });
        this.$el
            .find(">.ideafamily-body>.ideafamily-children")
            .append(rendered_children);
