...
class UserTOS extends View.extend({
    ...
    initialize() {
        ...
        var terms =
            terms_ls[Ctx.getLocale()] || _.first(_.values(terms_ls)) || "";
        this.terms = terms;
    }
    ...
    serializeData() {
        ...
        return {
            ...
            tos: this.terms,
            accepted:
                this.model.get("accepted_tos_version") ==
    ...
    acceptTos(e) {
        ...
        var discussionSettings = Ctx.getPreferences();
        this.model.set({
            accepted_tos_version: discussionSettings.tos_version,
        });
        ...
        this.model.save(null, {
            success: function (model, resp) {
                Growl.showBottomGrowl(
                    ...
                    i18n.gettext("Thank you for accepting!")
                );
            },
            error: function (model, resp) {
                Growl.showBottomGrowl(
                    Growl.GrowlReason.ERROR,
                    i18n.gettext("We could not register your acceptance.")
                );
            },
        });
    }
