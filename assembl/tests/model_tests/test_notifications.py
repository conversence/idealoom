...
def test_synthesis_notification_in_user_preferred_language_fr(
        test_session, discussion, participant1_user, test_app, root_post_1,
        participant1_user_language_preference_fr_cookie, synthesis_post_1):
    test_session.flush()
    subscription = NotificationSubscriptionFollowSyntheses(
        discussion=discussion,
        user=participant1_user,
...
def test_synthesis_notification_in_user_preferred_language_en(
        test_session, discussion, participant1_user, test_app, root_post_1,
        participant1_user_language_preference_en_cookie, synthesis_post_1):
    test_session.flush()
    subscription = NotificationSubscriptionFollowSyntheses(
        discussion=discussion,
        user=participant1_user,
